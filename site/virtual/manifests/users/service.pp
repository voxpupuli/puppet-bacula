class virtual::users::service {
  ...
  # to initiate builds and create preview releases for gated releases. Ssh keys
  # are managed in virtual::ssh_authorized_keys instead of here since keys
  # could vary on a per-host basis.
